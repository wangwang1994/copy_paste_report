...
def get_info(file_name):
    ...
    first_file_list.remove('轻型汽油车原始记录模板.xlsx')
    try:
...
gongsimingchengwenjianjia=input('请输入文件夹路径：')
file_name,chexing_list,baogaobianhao_dict,yangpinbianhao_dict,docx_dict,xlsx_dict=get_info(gongsimingchengwenjianjia)
# print(file_name)
# print(chexing_list)
...
for i in range(len(chexing_list)):
    ...
    os.chdir(file_name + '/' + chexing_list[i])
    print('打印出originexcel的名字')
    print(origin_excel)
    print(os.getcwd())
    def copy_to_excel(origin_excel, baogaobianhao, yangpinbianhao, jianyanshijian, jianyandidian, gongsimingcheng,
                      calid1, cvn1, calid2, cvn2):
        ...
        template = openpyxl.load_workbook("/Users/wangwang/Desktop/测试文件夹/轻型汽油车原始记录模板.xlsx")  # Add file name这里是黏贴的模版
        ...
        try:
            os.rename('/Users/wangwang/Desktop/excel_picture/xl/media/image1.jpeg',
                      '/Users/wangwang/Desktop/excel_picture/xl/media/image1.png')
        except:
            pass
        try:
            os.rename('/Users/wangwang/Desktop/excel_picture/xl/media/image1.jpg',
                      '/Users/wangwang/Desktop/excel_picture/xl/media/image1.png')
        except:
            pass
        ...
        try:
            os.rename('/Users/wangwang/Desktop/excel_picture/xl/media/image2.jpeg',
                      '/Users/wangwang/Desktop/excel_picture/xl/media/image2.png')
        except:
            print('没有第二张清单')
        try:
    ...
    copy_to_excel(origin_excel, baogaobianhao, yangpinbianhao, jianyanshijian, jianyandidian, gongsimingcheng, calid1, cvn1,
                  calid2, cvn2)
